#!/bin/bash
if ! [[ -e "./sourcer.build.source_test_sh/base/assert.source.sh" ]]; then
	./sourcer.build.source_test_sh/config.sh >/dev/null
fi

source ./sourcer.build.source_test_sh/base/assert.source.sh

test_sourcer_build_help()(
	assert_output_true test_sourcer_build_help_Get \
		--- assert_true 'source ./sourcer.build.source_test_sh/base/sourcer.build.source.sh --help'
...
test_sourcer_build_help_Get()(
	source ./sourcer.build.source_test_sh/base/sourcer.build.source.sh -h >/dev/null
	sourcer__build_help
)
...
test_sourcer_noexist()(
	assert_output_true test_sourcer_default_dir_noexist_output \
		---	assert_false 'source ./sourcer.build.source_test_sh/base/sourcer.build.source.sh'
	assert_output_true test_sourcer_noexist_output \
		---	assert_false 'source ./sourcer.build.source_test_sh/base/sourcer.build.source.sh ./sourcer.build.source_test_sh/file/sourcer_noexist'
...
test_sourcer_noexist_output(){
	echo
	echo "Error: Unable to locate 'sourcer.sh' in directory: './sourcer.build.source_test_sh/file/sourcer_noexist'". 
}
...
test_sourcer_build_source_noexist_output(){
	echo
	echo "Error: Unable to locate initial 'base' source directory: './sourcer.build.source_test_sh/file/build_source_noexist/base'."
}

test_sourcer_default_exist()(
	assert_true 'source ./sourcer.build.source_test_sh/base/sourcer.build.source.sh "" ./sourcer.build.source_test_sh/file/sourcer_exist'
...
test_sourcer__build_funcvar_exception_report()(
	source ./sourcer.build.source_test_sh/base/sourcer.build.source.sh '' '' ./sourcer.build.source_test_sh/file/build_funvar_exception_report/override.source.sh
...
test_sourcer__build_funcvar_exception_pipe()(
	...
	assert_output_true --- assert_true 'sourcer__build_funcvar_exception_pipe ./sourcer.build.source_test_sh/file/build_funvar_exception_pipe/base/pkga.source.sh'
	
	assert_output_true test_sourcer__build_funcvar_exception_pipe_override_warning_out \
		--- assert_true "sourcer__build_funcvar_exception_pipe './sourcer.build.source_test_sh/file/build_funvar_exception_pipe/override/pkga.source.sh'"
...
Warning: Source file: './sourcer.build.source_test_sh/file/build_funvar_exception_pipe/override/pkga.source.sh' contains variable 
...
Warning: Source file: './sourcer.build.source_test_sh/file/build_funvar_exception_pipe/override/pkga.source.sh' contains function 
...
Warning: Source file: './sourcer.build.source_test_sh/file/sourcer__build/warning/base/pkga.source.sh' contains variable 
  +    named: 'pkga_var_DECLARE_G' that should not already exist.
Warning: Source file: './sourcer.build.source_test_sh/file/sourcer__build/warning/base/pkga.source.sh' contains function 
  +    named: 'pkga_whoami_function_simple_define' that should not already exist.
Warning: Source file: './sourcer.build.source_test_sh/file/sourcer__build/warning/override/pkgb.source.sh' contains variable 
  +    named: 'pkgb_var_DECLARE_G' that should already exist.
Warning: Source file: './sourcer.build.source_test_sh/file/sourcer__build/warning/override/pkgb.source.sh' contains function 
...
Error: Source file: './sourcer.build.source_test_sh/file/sourcer__build/error/base/pkga.source.sh' contains variable 
  +    named: 'pkga_var_DECLARE_G' that should not already exist.
Error: Source file: './sourcer.build.source_test_sh/file/sourcer__build/error/base/pkga.source.sh' contains function 
  +    named: 'pkga_whoami_function_simple_define' that should not already exist.
TEST_SOURCER__BUILD_EXCEPTION_TESTING_ENABLE_ERROR
}
